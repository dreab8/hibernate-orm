...
[IMPORTANT]
====
To use this integration, the application must include the hibernate-orm-c3p0 module jar (as well as its dependencies) on the classpath.
====
...
[IMPORTANT]
====
To use this integration, the application must include the hibernate-orm-proxool module jar (as well as its dependencies) on the classpath.
====
