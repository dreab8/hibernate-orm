...
One such example is a mismatch between a property defined as an `org.hibernate.type.DateTypeImpl` and a property defined as an `org.hibernate.type.TimestampTypeImpl`,
