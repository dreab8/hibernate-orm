...
For inject/extract, considering mixed value arrays, a few options:

	1. we could extract sub-arrays as needed
	2. obtain injector/extractor objects based on an offset
	3. incorporate offset into injector/extractor contracts
