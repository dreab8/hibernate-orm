 ...
 */
public class GeolatteGeometryTypeImpl extends BasicTypeImpl<Geometry> implements Spatial {
	 ...
	 */
	public GeolatteGeometryTypeImpl(SqlTypeDescriptor sqlTypeDescriptor) {
