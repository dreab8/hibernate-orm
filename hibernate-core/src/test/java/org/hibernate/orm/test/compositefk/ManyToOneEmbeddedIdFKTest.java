...
@DomainModel(
		annotatedClasses = {
				ManyToOneEmbeddedIdFKTest.System.class,
				ManyToOneEmbeddedIdFKTest.SystemUser.class,
				ManyToOneEmbeddedIdFKTest.PK.class
		}
)
@SessionFactory
public class ManyToOneEmbeddedIdFKTest {
	...
	@Test
	public void testEmbeddedIdParamater(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
