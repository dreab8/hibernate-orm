...
@DomainModel(
		annotatedClasses = {
				MultipleCollectionsCascadeRefreshTest.Parent.class,
				MultipleCollectionsCascadeRefreshTest.EntityA.class,
				MultipleCollectionsCascadeRefreshTest.EntityB.class,
		}
)
@SessionFactory(statementInspectorClass = SQLStatementInspector.class)
public class MultipleCollectionsCascadeRefreshTest {
	...
	public void testCascadeRefreshWithUninitializedCollection(SessionFactoryScope scope) {
		...
		scope.inTransaction(
				session -> {
					CollectionCascadeRefreshTest.EntityA child1 = session.find( CollectionCascadeRefreshTest.EntityA.class, ENTITY_A_1_ID );
					child1.setName( "new A 1" );

					CollectionCascadeRefreshTest.EntityB entityB = child1.getEntityB();
					entityB.setName( "new B 1" );

					CollectionCascadeRefreshTest.Parent parent = session.find( CollectionCascadeRefreshTest.Parent.class, PARENT_ID );
