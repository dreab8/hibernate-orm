...
public class EntityWithBidirectionalOneToOneTest {
	...
	public void testGetAdoptedChild(SessionFactoryScope scope) {
		...
		scope.inTransaction( session -> {
			...
			statementInspector.assertExecutedCount( 1 );
			/*
				fetchablePath: AdoptedChild.biologicalMother --- NO circular --- 1
				fetchablePath: AdoptedChild.biologicalMother.biologicalChild --- NO circular --- 2
				fetchablePath: AdoptedChild.biologicalMother.biologicalChild.mother --- Circular ---
				fetchablePath: AdoptedChild.biologicalMother.adopted --- NO circular --- 3
				fetchablePath: AdoptedChild.biologicalMother.adopted.biologicalMother --- NO circular --- 4
