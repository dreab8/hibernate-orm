 ...
 * @author Strong Liu
 */
public class CharacterArrayTextTypeImpl extends BasicTypeImpl<Character[]> {
	public static final CharacterArrayTextTypeImpl INSTANCE = new CharacterArrayTextTypeImpl();

	public CharacterArrayTextTypeImpl() {
