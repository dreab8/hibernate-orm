 ...
 * @author Gail Badner
 */
public class StoredPrefixedStringTypeImpl
	...
	public static final StoredPrefixedStringTypeImpl INSTANCE = new StoredPrefixedStringTypeImpl();

	public StoredPrefixedStringTypeImpl() {
		super( PREFIXED_VARCHAR_TYPE_DESCRIPTOR, StringTypeImpl.INSTANCE.getJavaTypeDescriptor() );
	}

	public String getName() {
		return StringTypeImpl.INSTANCE.getName();
	}
	...
	public String objectToSQLString(String value, Dialect dialect) throws Exception {
		return StringTypeImpl.INSTANCE.objectToSQLString( value, dialect );
	}

	public String stringToObject(String xml) throws Exception {
		return StringTypeImpl.INSTANCE.stringToObject( xml );
	}

	public String toString(String value) {
		return StringTypeImpl.INSTANCE.toString( value );
	}
}
