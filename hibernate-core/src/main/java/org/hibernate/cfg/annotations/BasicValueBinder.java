...
public class BasicValueBinder<T> {
	...
	private AttributeConverterDefinition converterDescriptor;
	...
	private void applyAttributeConverter(XProperty property, AttributeConverterDefinition attributeConverterDescriptor, boolean key) {
