...
public class VersionTypeSeedParameterSpecification implements ParameterSpecification {
	 ...
	 */
	public VersionTypeSeedParameterSpecification(BasicType type) {
		this.type = type;
	}
	...
	public int bind(
		...
		type.nullSafeSet( statement, type.getJavaTypeDescriptor().getVersionSupport().seed( session ), position, session );
		return 1;
	}
