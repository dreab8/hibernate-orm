 ...
 */
public class RefreshVisitor extends AbstractVisitor {
	private static final CoreMessageLogger LOG = CoreLogging.messageLogger( EvictVisitor.class );

	private Object owner;

	public RefreshVisitor(EventSource session, Object owner) {
		super( session );
		this.owner = owner;
	}
	...
	public void evictCollection(Object value, CollectionType type) {
		...
		if ( collection != null && collection.wasInitialized() && collection.unsetSession( session ) ) {
