 ...
 */
public class Component extends SimpleValue implements MetaAttributable, EmbeddedValueMappingImplementor {
	...
	/**
	 * @deprecated User {@link Component#Component(MetadataBuildingContext, MappedTable, PersistentClass)} instead.
	 */
	@Deprecated
