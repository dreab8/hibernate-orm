...
public class OneToOne extends ToOne {
	...
	public void setSqlTypeDescriptorResolver(Column column) {
		column.setSqlTypeDescriptorResolver( new OneToOneSqlTypeDescriptorResolver( columns.size() - 1 ) );
	}

	public class OneToOneSqlTypeDescriptorResolver implements SqlTypeDescriptorResolver {

		private int index;

		public OneToOneSqlTypeDescriptorResolver(int index) {
			this.index = index;
		}
