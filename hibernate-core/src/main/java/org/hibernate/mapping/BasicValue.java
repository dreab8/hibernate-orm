...
public class BasicValue extends SimpleValue implements BasicValueMapping {
	...
	private AttributeConverterDefinition attributeConverterDescriptor;
	...
	public AttributeConverterDefinition getAttributeConverterDescriptor() {
	...
	public void setJpaAttributeConverterDescriptor(AttributeConverterDefinition attributeConverterDescriptor) {
	...
	public static class BasicTypeResolverUsingReflection extends BasicTypeResolverConvertibleSupport {
		...
		public BasicTypeResolverUsingReflection(
				...
				AttributeConverterDefinition converterDefinition,
				String className,
				String propertyName,
				boolean isLob,
