...
public class StandardUniqueKeyExporter implements Exporter<UniqueKey> {
	...
	@Override
	public String[] getSqlCreateStrings(org.hibernate.metamodel.model.relational.spi.UniqueKey uniqueKey, JdbcServices jdbcServices) {
		return new String[] {
	...
	@Override
	public String[] getSqlDropStrings(org.hibernate.metamodel.model.relational.spi.UniqueKey uniqueKey, JdbcServices jdbcServices) {
		return new String[] {
