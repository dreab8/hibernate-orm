 ...
 */
public class CharacterTypeImpl
		extends BasicTypeImpl<Character>
		implements PrimitiveType<Character>, DiscriminatorType<Character> {

	public static final CharacterTypeImpl INSTANCE = new CharacterTypeImpl();

	public CharacterTypeImpl() {
		super( CharSqlDescriptor.INSTANCE, CharacterJavaDescriptor.INSTANCE );
	}
