 ...
 */
public class YesNoTypeImpl
		extends BasicTypeImpl<Boolean>
		implements PrimitiveType<Boolean>, DiscriminatorType<Boolean> {

	public static final YesNoTypeImpl INSTANCE = new YesNoTypeImpl();

	public YesNoTypeImpl() {
	...
	public String objectToSQLString(Boolean value, Dialect dialect) throws Exception {
		return StringTypeImpl.INSTANCE.objectToSQLString( value ? "Y" : "N", dialect );
	}
}
