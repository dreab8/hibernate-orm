...
import org.hibernate.metamodel.model.domain.internal.LongVersionSupport;
...
public class LongJavaDescriptor extends AbstractNumericJavaDescriptor<Long> implements Primitive<Long> {
	...
	public SqlTypeDescriptor getJdbcRecommendedSqlType(JdbcRecommendedSqlTypeMappingContext context) {
		return context.getTypeConfiguration().getSqlTypeDescriptorRegistry().getSqlTypeDescriptor( Types.BIGINT );
	}
