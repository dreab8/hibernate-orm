 ...
 */
public class TimeSqlDescriptor implements SqlTypeDescriptor {
		...
		return new BasicExtractor<X>( javaTypeDescriptor, this ) {
			...
			protected X doExtract(ResultSet rs, int position, WrapperOptions options) throws SQLException {
				return options.getJdbcTimeZone() != null ?
						javaTypeDescriptor.wrap( rs.getTime( position, Calendar.getInstance( options.getJdbcTimeZone() ) ), options ) :
						javaTypeDescriptor.wrap( rs.getTime( position ), options );
			}
