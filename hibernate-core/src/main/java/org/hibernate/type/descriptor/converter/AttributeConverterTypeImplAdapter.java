 ...
 */
public class AttributeConverterTypeImplAdapter<T> extends BasicTypeImpl<T> {
	private static final Logger log = Logger.getLogger( AttributeConverterTypeImplAdapter.class );
	...
	public AttributeConverterTypeImplAdapter(
			String name,
			String description,
		...
		log.debug( "Created AttributeConverterTypeImplAdapter -> " + name );
	}
