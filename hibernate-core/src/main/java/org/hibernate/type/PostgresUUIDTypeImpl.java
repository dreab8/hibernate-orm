 ...
 */
public class PostgresUUIDTypeImpl extends BasicTypeImpl<UUID> {
	public static final PostgresUUIDTypeImpl INSTANCE = new PostgresUUIDTypeImpl();

	public PostgresUUIDTypeImpl() {
