 ...
 */
public class TimeZoneTypeImpl
		extends BasicTypeImpl<TimeZone>
		implements LiteralType<TimeZone> {

	public static final TimeZoneTypeImpl INSTANCE = new TimeZoneTypeImpl();

	public TimeZoneTypeImpl() {
		super( VarcharSqlDescriptor.INSTANCE, TimeZoneJavaDescriptor.INSTANCE );
	}
	...
	public String objectToSQLString(TimeZone value, Dialect dialect) throws Exception {
		return StringTypeImpl.INSTANCE.objectToSQLString( value.getID(), dialect );
	}
