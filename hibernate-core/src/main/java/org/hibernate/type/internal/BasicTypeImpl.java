...
public class BasicTypeImpl<T>
	...
	public BasicTypeImpl(SqlTypeDescriptor sqlTypeDescriptor, JavaTypeDescriptor<T> javaTypeDescriptor) {
		super( sqlTypeDescriptor, javaTypeDescriptor );
	}

	public BasicTypeImpl(JavaTypeDescriptor<T> javaTypeDescriptor, SqlTypeDescriptor sqlTypeDescriptor ) {
		super( sqlTypeDescriptor, javaTypeDescriptor );
	}
