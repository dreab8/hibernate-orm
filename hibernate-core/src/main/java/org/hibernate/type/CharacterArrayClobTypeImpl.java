 ...
 * <p/>
 * Essentially a {@link MaterializedClobTypeImpl} but represented as a Character[] in Java rather than String.
 *
 * @author Emmanuel Bernard
 * @author Steve Ebersole
 */
public class CharacterArrayClobTypeImpl extends BasicTypeImpl<Character[]> {
	public static final CharacterArrayClobTypeImpl INSTANCE = new CharacterArrayClobTypeImpl();

	public CharacterArrayClobTypeImpl() {
