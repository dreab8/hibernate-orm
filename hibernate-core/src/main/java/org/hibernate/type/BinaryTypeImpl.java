 ...
 * For binary entity versions/timestamps, {@link RowVersionTypeImpl} should be used instead.
 *
 * @author Gavin King
...
public class BinaryTypeImpl
	...
	public static final BinaryTypeImpl INSTANCE = new BinaryTypeImpl();
	 ...
	 * @deprecated use {@link RowVersionTypeImpl} for binary entity versions/timestamps
	 */
	@Override
	@Deprecated
