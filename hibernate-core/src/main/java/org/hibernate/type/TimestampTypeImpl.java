...
public class TimestampTypeImpl
	...
	public static final TimestampTypeImpl INSTANCE = new TimestampTypeImpl();

	public TimestampTypeImpl() {
	...
	public String objectToSQLString(Date value, Dialect dialect) throws Exception {
		...
		return StringTypeImpl.INSTANCE.objectToSQLString( ts.toString(), dialect );
	}
