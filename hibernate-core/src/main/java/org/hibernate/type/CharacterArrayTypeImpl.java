 ...
 */
public class CharacterArrayTypeImpl extends BasicTypeImpl<Character[]> {
	public static final CharacterArrayTypeImpl INSTANCE = new CharacterArrayTypeImpl();

	public CharacterArrayTypeImpl() {
