 ...
 */
public class DoubleTypeImpl extends BasicTypeImpl<Double> implements PrimitiveType<Double> {
	public static final DoubleTypeImpl INSTANCE = new DoubleTypeImpl();

	public static final Double ZERO = 0.0;

	public DoubleTypeImpl() {
		super( DoubleSqlDescriptor.INSTANCE, DoubleJavaDescriptor.INSTANCE );
	}
	@Override
