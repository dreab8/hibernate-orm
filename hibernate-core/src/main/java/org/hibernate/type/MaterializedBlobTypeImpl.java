 ...
 */
public class MaterializedBlobTypeImpl extends BasicTypeImpl<byte[]> {
	public static final MaterializedBlobTypeImpl INSTANCE = new MaterializedBlobTypeImpl();

	public MaterializedBlobTypeImpl() {
