 ...
 * <li>{@link #SerializableTypeImpl(Class)} indicates a mapping using the specific class</li>
 * </ul>
 ...
 */
public class SerializableTypeImpl<T extends Serializable> extends BasicTypeImpl<T> {
	public static final SerializableTypeImpl<Serializable> INSTANCE = new SerializableTypeImpl<>( Serializable.class );

	private final Class<T> serializableClass;

	public SerializableTypeImpl(Class<T> serializableClass) {
