...
/**
 * <tt>dbtimestamp</tt>: An extension of {@link TimestampTypeImpl} which
 ...
 */
public class DbTimestampTypeImpl extends TimestampTypeImpl {
	public static final DbTimestampTypeImpl INSTANCE = new DbTimestampTypeImpl();

	private static final CoreMessageLogger LOG = Logger.getMessageLogger(
			CoreMessageLogger.class,
			DbTimestampTypeImpl.class.getName()
	);
