 ...
 * @author Strong Liu
 */
public class WrappedMaterializedBlobTypeImpl extends BasicTypeImpl<Byte[]> {
	public static final WrappedMaterializedBlobTypeImpl INSTANCE = new WrappedMaterializedBlobTypeImpl();

	public WrappedMaterializedBlobTypeImpl() {
