 ...
 */
public class ClobTypeImpl extends BasicTypeImpl<Clob> {
	public static final ClobTypeImpl INSTANCE = new ClobTypeImpl();

	public ClobTypeImpl() {
		super( ClobSqlDescriptor.DEFAULT, ClobJavaDescriptor.INSTANCE );
	}
