 ...
 */
public class LocalDateTimeTypeImpl
		extends BasicTypeImpl<LocalDateTime>
		implements VersionType<LocalDateTime>, LiteralType<LocalDateTime> {
	/**
	 * Singleton access
	 */
	public static final LocalDateTimeTypeImpl INSTANCE = new LocalDateTimeTypeImpl();

	public static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern( "yyyy-MM-dd HH:mm:ss.S", Locale.ENGLISH );

	public LocalDateTimeTypeImpl() {
		super( TimestampSqlDescriptor.INSTANCE, LocalDateTimeJavaDescriptor.INSTANCE );
	}
