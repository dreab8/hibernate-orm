 ...
 */
public class MaterializedNClobTypeImpl extends BasicTypeImpl<String> {
	public static final MaterializedNClobTypeImpl INSTANCE = new MaterializedNClobTypeImpl();

	public MaterializedNClobTypeImpl() {
