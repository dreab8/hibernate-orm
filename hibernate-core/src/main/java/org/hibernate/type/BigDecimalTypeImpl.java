 ...
 */
public class BigDecimalTypeImpl extends BasicTypeImpl<BigDecimal> {
	public static final BigDecimalTypeImpl INSTANCE = new BigDecimalTypeImpl();

	public BigDecimalTypeImpl() {
