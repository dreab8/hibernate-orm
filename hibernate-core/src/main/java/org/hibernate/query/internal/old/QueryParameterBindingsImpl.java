...
public class QueryParameterBindingsImpl implements QueryParameterBindings {
	...
	public static QueryParameterBindingsImpl from(
		...
		return from( parameterMetadata, producer.getFactory() );
	}
	...
	public static QueryParameterBindingsImpl from(
		...
		if ( parameterMetadata == null ) {
			// should indicate a ProcedureCall, although not a named ProcedureCall iirc
			return new QueryParameterBindingsImpl( sessionFactory, null );
		}
		else {
