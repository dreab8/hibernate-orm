...
public class DynamicResultBuilderEntityStandard
	...
	public FetchBuilder findFetchBuilder(String fetchableName) {
		final ModelPart subPart = entityMapping.findSubPart( fetchableName );
		return findFetchBuilder( (Fetchable) subPart );
	}

	@Override
	public DynamicResultBuilderEntityStandard addProperty(String propertyName, String columnAlias) {
	...
	@Override
	public void addFetchBuilder(String fetchableName, FetchBuilder fetchBuilder) {
		addFetchBuilder( (Fetchable) entityMapping.findSubPart( fetchableName ), fetchBuilder );
	}
