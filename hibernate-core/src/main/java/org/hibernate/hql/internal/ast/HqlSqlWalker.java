	...
	protected void createFromJoinElement(
		...
		if ( entityJoinReferencedPersister != null ) {
			...
			if ( dot.getDataType() != null && dot.getDataType().isComponentType() ) {
				...
				fromElement = factory.createComponentJoin( (EmbeddedType) dot.getDataType() );
			}
			else {
...
//		}
	...
	protected void postProcessInsert(AST insert) throws SemanticException, QueryException {
		...
		if ( includeVersionProperty ) {
			...
			if ( sessionFactoryHelper.getFactory().getDialect().supportsParametersInInsertSelect() ) {
				int[] sqlTypes = versionType.sqlTypes();
				...
				if ( isIntegral( versionType ) ) {
					try {
						Object seedValue = ((VersionSupport)versionType).seed( null );
	...
	private boolean isTimestampBasedVersion(Type versionType) {
