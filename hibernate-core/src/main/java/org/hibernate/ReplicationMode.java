...
public enum ReplicationMode {
	...
	EXCEPTION {
		@Override
		public boolean shouldOverwriteCurrentVersion(Object entity, Object currentVersion, Object newVersion, BasicType versionType) {
	...
	LATEST_VERSION {
		...
		public boolean shouldOverwriteCurrentVersion(Object entity, Object currentVersion, Object newVersion, BasicType versionType) {
			...
			return versionType == null || versionType.getJavaTypeDescriptor().getVersionSupport().getComparator().compare( currentVersion, newVersion ) <= 0;
		}
	};
	 ...
	 */
	public abstract boolean shouldOverwriteCurrentVersion(Object entity, Object currentVersion, Object newVersion, BasicType versionType);
